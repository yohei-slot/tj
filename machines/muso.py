...
def muso():
    ...
    st.markdown("・チェリーが6pt以上<br>・チャンスベルが6pt以上<br>・スイカが8pt以上<br>・チャンス目が4pt以上<br>")
    st.subheader("その他出てきたら無条件で打てる示唆")
    st.markdown("・キリン柄ステチェン（32宿命以内当選&ブルーセブンモード濃厚）<br>・1000宿命以上での赤ステチェン（100宿命以内当選&ブルーセブンモード濃厚）<br>・ユリアポイント示唆「最強」")
    st.subheader("やめどき")
